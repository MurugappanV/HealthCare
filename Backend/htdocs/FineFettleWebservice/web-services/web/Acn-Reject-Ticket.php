...
if(isset($_POST['vendor_id']))
{
	...
	$request_id = $_POST['request_id'];
				$sql_emp = mysqli_query($acn_con,"update customer_request_product set sub_vendor_id='".$vendorid."',service_status='".$typestatus."',reject_date='".date("Y-m-d")."',forward_status=3 WHERE request_id='".$request_id."' " );
