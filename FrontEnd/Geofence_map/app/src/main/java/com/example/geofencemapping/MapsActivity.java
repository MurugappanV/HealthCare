package com.example.geofencemapping;
...
public class MapsActivity extends FragmentActivity implements LocationListener {
    ...
    public void  getlogin( final String latitude,final String longitude,final String device, final String dest_lat, final String dest_lon,final String radius ) {
        StringRequest postRequest = new StringRequest(Request.Method.POST, Root.URL + LocationApi.Login, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.e("", "" + Root.URL + LocationApi.Login);
