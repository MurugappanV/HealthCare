...
import com.example.surya.fine_fettle.adapter.PatientBookingHistoryAdapter;
...
public class PatitentBookingHistoryActivity extends AppCompatActivity implements View.OnClickListener {


    String doc_id;
    private Context mContext;
    private RecyclerView mRecyclerView;
    private PatientBookingHistoryAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patitent_booking);
        processBundle();
    ...
    private void initObjects() {
        mContext = this;
        mRecyclerView = findViewById(R.id.recyclerview_booking);
        mImageBack = findViewById(R.id.img_back);
        mLayoutManager = new LinearLayoutManager(mContext);
        mhistoryList = new ArrayList<>();
        mAdapter = new PatientBookingHistoryAdapter(mContext, mhistoryList);
    }
    ...
    public void getBookingHistory(final String doc_id) {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, Root.URL + AppConfig.Booking_history, new Response.Listener<String>() {
            @Override
        ...
        try {
            ...
            if (success == 200) {
                for (int j = 0; j < jsonArray.length(); j++) {
                    ...
                    String doctor_status = userObj22.getString("appointment_status");
                    mhistoryList.add(new Patienthistory(patient_name, patient_age, appoinment_date,appointment_time,patient_problem,doctor_status));
